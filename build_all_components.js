...
/* Custom styling for luxury gold / wax reflections */
.gold-shimmer {
  background: linear-gradient(120deg, #d4af37 0%, #fef3c7 40%, #b89628 70%, #fcd34d 100%);
...
// 3. src/components/guest/EnvelopeExperience.tsx
writeFile('src/components/guest/EnvelopeExperience.tsx', `import React, { useState } from 'react';
...
console.log('Components batch 1 written');
