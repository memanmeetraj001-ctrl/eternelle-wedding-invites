...
export const FOIL_FINISH_OPTIONS: Record<FoilFinishId, FoilFinishOption> = {
  'gold': {
    ...
    sampleHex: '#d4af37',
    textGradientClass: 'bg-gradient-to-r from-[#ffe082] via-[#ffc107] to-[#d4af37] bg-clip-text text-transparent drop-shadow-[0_1px_2px_rgba(212,175,55,0.4)]',
    borderClass: 'border-amber-400/80 shadow-[0_0_15px_rgba(212,175,55,0.25)]',
    shimmerStyle: {
      backgroundImage: 'linear-gradient(120deg, #d4af37 0%, #fff5c0 45%, #d4af37 70%, #aa8210 100%)',
  ...
  'rose-gold': {
    ...
    sampleHex: '#b76e79',
    textGradientClass: 'bg-gradient-to-r from-[#fddad4] via-[#e8a598] to-[#b76e79] bg-clip-text text-transparent drop-shadow-[0_1px_2px_rgba(183,110,121,0.4)]',
    borderClass: 'border-rose-400/80 shadow-[0_0_15px_rgba(183,110,121,0.25)]',
    shimmerStyle: {
      backgroundImage: 'linear-gradient(120deg, #b76e79 0%, #ffdfd7 45%, #b76e79 70%, #8b434e 100%)',
      WebkitBackgroundClip: 'text',
      WebkitTextFillColor: 'transparent',
    },
  },
  'silver': {
    ...
    sampleHex: '#e0e0e0',
    textGradientClass: 'bg-gradient-to-r from-[#ffffff] via-[#e0e0e0] to-[#b0b0b0] bg-clip-text text-transparent drop-shadow-[0_1px_2px_rgba(255,255,255,0.4)]',
    borderClass: 'border-slate-300/80 shadow-[0_0_15px_rgba(255,255,255,0.25)]',
    shimmerStyle: {
      backgroundImage: 'linear-gradient(120deg, #b0b0b0 0%, #ffffff 45%, #cccccc 70%, #888888 100%)',
      WebkitBackgroundClip: 'text',
      WebkitTextFillColor: 'transparent',
    },
  },
  'emerald': {
    ...
    sampleHex: '#2e7d32',
    textGradientClass: 'bg-gradient-to-r from-[#a7f3d0] via-[#34d399] to-[#059669] bg-clip-text text-transparent drop-shadow-[0_1px_2px_rgba(52,211,153,0.4)]',
    borderClass: 'border-emerald-400/80 shadow-[0_0_15px_rgba(52,211,153,0.25)]',
    shimmerStyle: {
      backgroundImage: 'linear-gradient(120deg, #065f46 0%, #6ee7b7 45%, #059669 70%, #022c22 100%)',
      WebkitBackgroundClip: 'text',
      WebkitTextFillColor: 'transparent',
    },
  },
