...
export const BrandLogo: React.FC<BrandLogoProps> = ({ size = 'md', showText = true }) => {
  ...
  return (
    <div className="flex items-center gap-2.5 select-none">
      ...
      {showText && (
        <div>
          <span className="font-serif text-lg tracking-[0.2em] text-stone-900 font-semibold block leading-none">
            ÉTERNELLE
          </span>
          <span className="text-[9px] text-stone-500 font-sans tracking-wider block mt-0.5">
